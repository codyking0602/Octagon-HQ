...
export const CFB_BUILD_QB_PEAK_SEASON_AUDIT: readonly CfbBuildQbPeakAuditRow[] = [
  ...
  peak("Aaron Rodgers", 2004, "California", "cfb-aaron-rodgers", 3, [9, 9, 9, 6, 8]),
  peak("Charlie Ward", 1993, "Florida State", "cfb-charlie-ward", 4, [7, 8, 8, 8, 9]),
  peak("Andrew Luck", 2011, "Stanford", "cfb-andrew-luck", 4, [8, 9, 9, 7, 8]),
  peak("Matt Ryan", 2007, "Boston College", "cfb-matt-ryan", 3, [7, 8, 9, 5, 9]),
  peak("Jimmy Clausen", 2009, "Notre Dame", "cfb-jimmy-clausen", 3, [8, 9, 8, 4, 7]),
  peak("Sam Ehlinger", 2018, "Texas", "cfb-sam-ehlinger", 3, [7, 7, 7, 9, 9]),
  peak("Teddy Bridgewater", 2013, "Louisville", "cfb-teddy-bridgewater", 3, [7, 9, 9, 7, 8]),
  peak("Russell Wilson", 2011, "Wisconsin", "cfb-russell-wilson", 4, [7, 9, 9, 8, 9]),
  ...
  peak("Marcus Vick", 2005, "Virginia Tech", "cfb-marcus-vick", 2, [8, 8, 7, 9, 6]),
  ...
  peak("Michael Vick", 1999, "Virginia Tech", "cfb-michael-vick", 4, [9, 6, 6, 9, 9]),
