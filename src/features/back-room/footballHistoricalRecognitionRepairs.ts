...
export const footballHistoricalRecognitionRepairs: readonly FootballHistoricalRecognitionRepair[] = [
  ...
  player("cfb-paul-hornung", "Paul Hornung", "CFB", "QB", 1954, 1956, "A", "heisman", "Notre Dame"),
  player("cfb-billy-cannon", "Billy Cannon", "CFB", "RB", 1957, 1959, "A", "heisman", "LSU"),
  ...
  player("cfb-billy-sims", "Billy Sims", "CFB", "RB", 1975, 1979, "A", "heisman", "Oklahoma"),
  player("cfb-george-rogers", "George Rogers", "CFB", "RB", 1977, 1980, "B", "heisman", "South Carolina"),
  player("cfb-marcus-allen", "Marcus Allen", "CFB", "RB", 1978, 1981, "A", "heisman", "USC"),
  player("cfb-herschel-walker", "Herschel Walker", "CFB", "RB", 1980, 1982, "A", "heisman", "Georgia"),
  player("cfb-mike-rozier", "Mike Rozier", "CFB", "RB", 1981, 1983, "B", "heisman", "Nebraska"),
  ...
  player("cfb-vinny-testaverde", "Vinny Testaverde", "CFB", "QB", 1982, 1986, "B", "heisman", "Miami"),
  ...
  player("cfb-andre-ware", "Andre Ware", "CFB", "QB", 1987, 1989, "B", "heisman", "Houston"),
  ...
  player("cfb-charlie-ward", "Charlie Ward", "CFB", "QB", 1989, 1993, "B", "heisman", "Florida State"),
  ...
  player("cfb-eric-crouch", "Eric Crouch", "CFB", "QB", 1998, 2001, "B", "heisman", "Nebraska"),
  player("cfb-matt-leinart", "Matt Leinart", "CFB", "QB", 2002, 2005, "A", "heisman", "USC"),
  player("cfb-derrick-henry", "Derrick Henry", "CFB", "RB", 2013, 2015, "A", "heisman", "Alabama"),
  player("cfb-lamar-jackson", "Lamar Jackson", "CFB", "QB", 2015, 2017, "A", "heisman", "Louisville"),
  player("cfb-joe-burrow", "Joe Burrow", "CFB", "QB", 2015, 2019, "A", "heisman", "LSU"),
  player("cfb-bryce-young", "Bryce Young", "CFB", "QB", 2020, 2022, "B", "heisman", "Alabama"),
  player("cfb-caleb-williams", "Caleb Williams", "CFB", "QB", 2021, 2023, "B", "heisman", "USC"),
  player("cfb-fernando-mendoza", "Fernando Mendoza", "CFB", "QB", 2023, 2025, "B", "heisman", "Indiana"),
