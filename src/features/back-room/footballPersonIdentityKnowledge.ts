...
export const footballPersonIdentityKnowledgeSources: readonly FootballFactSource[] = [
  ...
  source("identity-gronk-arizona", "Arizona Athletics", "Rob Gronkowski - Football", "https://arizonawildcats.com/sports/football/roster/rob-gronkowski/147", "Rob Gronkowski's basketball background, high-school move, and Arizona tight-end records."),
  source("identity-gronk-patriots-rookie", "New England Patriots", "Meet the Rookies: TE Rob Gronkowski", "https://www.patriots.com/news/meet-the-rookies-te-rob-gronkowski-146796", "Rob Gronkowski's athletic family, 2009 back surgery, and Patriots trade-up in the 2010 draft."),
  source("identity-gronk-arizona-superbowl", "Arizona Athletics", "Gronkowski Joins Super Bowl Cats", "https://arizonawildcats.com/sports/2012/1/24/207926919", "Rob Gronkowski missing the 2009 season, entering the draft, and the Gronking spike identity."),
...
export const footballPersonIdentityKnowledgeRecords: readonly FootballPersonIdentityKnowledgeRecord[] = [
  ...
  { subjectId: "nfl-terrell-owens", facts: [
  ...
  { subjectId: "nfl-rob-gronkowski", facts: [
    fact("high-school-basketball-center", "prep-basketball-dominance", "Before his senior high-school move to Pennsylvania, he was also a standout basketball center who averaged 21 points and 18 rebounds.", ["identity-gronk-arizona"], ["high-school", "basketball"]),
    fact("four-athletic-brothers", "gronkowski-athletic-family", "He grew up in an unusually athletic family: his father played football at Syracuse and his four brothers also pursued high-level sports.", ["identity-gronk-patriots-rookie"], ["family", "multi-sport"]),
    fact("arizona-tight-end-records", "arizona-position-record-book", "In only two playing seasons he left Arizona with the school's major single-game, season, and career receiving records for a tight end.", ["identity-gronk-arizona", "identity-gronk-arizona-superbowl"], ["college", "breakthrough"]),
    fact("missed-entire-2009-back", "college-back-surgery-lost-season", "A back injury and surgery wiped out his entire 2009 Arizona season before he entered the NFL draft.", ["identity-gronk-patriots-rookie", "identity-gronk-arizona-superbowl"], ["college", "adversity"]),
    fact("patriots-traded-up-42", "injury-risk-draft-trade-up", "Despite the lost season and medical questions, New England traded up to take him 42nd overall in the second round of the 2010 draft.", ["identity-gronk-patriots-rookie"], ["draft", "career-turning-point"]),
  ]},
