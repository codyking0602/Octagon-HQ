...
-- Population: four strongest 1999-2025 seasons per current franchise, derived from
-- the repository's pinned nflverse team-season results corpus.
...
insert into private.draft_room_nfl_divisions_pool (
  ...
  ('nfl-division-buf-2024', 2024, 'BUF', 'Buffalo Bills', 'AFC East', '2024 Buffalo Bills', 88.5),
  ('nfl-division-buf-2020', 2020, 'BUF', 'Buffalo Bills', 'AFC East', '2020 Buffalo Bills', 88.5),
  ('nfl-division-buf-2022', 2022, 'BUF', 'Buffalo Bills', 'AFC East', '2022 Buffalo Bills', 86.5),
  ('nfl-division-buf-2021', 2021, 'BUF', 'Buffalo Bills', 'AFC East', '2021 Buffalo Bills', 84.5),
  ('nfl-division-mia-2000', 2000, 'MIA', 'Miami Dolphins', 'AFC East', '2000 Miami Dolphins', 82.0),
  ('nfl-division-mia-2023', 2023, 'MIA', 'Miami Dolphins', 'AFC East', '2023 Miami Dolphins', 81.0),
  ('nfl-division-mia-2001', 2001, 'MIA', 'Miami Dolphins', 'AFC East', '2001 Miami Dolphins', 80.5),
  ('nfl-division-mia-2008', 2008, 'MIA', 'Miami Dolphins', 'AFC East', '2008 Miami Dolphins', 80.0),
  ...
  ('nfl-division-ne-2007', 2007, 'NE', 'New England Patriots', 'AFC East', '2007 New England Patriots', 98.0),
  ('nfl-division-ne-2003', 2003, 'NE', 'New England Patriots', 'AFC East', '2003 New England Patriots', 97.5),
  ('nfl-division-nyj-2010', 2010, 'NYJ', 'New York Jets', 'AFC East', '2010 New York Jets', 84.5),
  ('nfl-division-nyj-2009', 2009, 'NYJ', 'New York Jets', 'AFC East', '2009 New York Jets', 83.5),
  ('nfl-division-nyj-2004', 2004, 'NYJ', 'New York Jets', 'AFC East', '2004 New York Jets', 81.0),
  ('nfl-division-nyj-2015', 2015, 'NYJ', 'New York Jets', 'AFC East', '2015 New York Jets', 79.5),
  ('nfl-division-bal-2000', 2000, 'BAL', 'Baltimore Ravens', 'AFC North', '2000 Baltimore Ravens', 98.5),
  ('nfl-division-bal-2012', 2012, 'BAL', 'Baltimore Ravens', 'AFC North', '2012 Baltimore Ravens', 92.5),
  ('nfl-division-bal-2023', 2023, 'BAL', 'Baltimore Ravens', 'AFC North', '2023 Baltimore Ravens', 89.0),
  ('nfl-division-bal-2019', 2019, 'BAL', 'Baltimore Ravens', 'AFC North', '2019 Baltimore Ravens', 89.0),
  ('nfl-division-cin-2022', 2022, 'CIN', 'Cincinnati Bengals', 'AFC North', '2022 Cincinnati Bengals', 87.0),
  ('nfl-division-cin-2021', 2021, 'CIN', 'Cincinnati Bengals', 'AFC North', '2021 Cincinnati Bengals', 87.0),
  ('nfl-division-cin-2015', 2015, 'CIN', 'Cincinnati Bengals', 'AFC North', '2015 Cincinnati Bengals', 84.0),
  ('nfl-division-cin-2013', 2013, 'CIN', 'Cincinnati Bengals', 'AFC North', '2013 Cincinnati Bengals', 82.5),
  ('nfl-division-cle-2020', 2020, 'CLE', 'Cleveland Browns', 'AFC North', '2020 Cleveland Browns', 80.0),
  ('nfl-division-cle-2023', 2023, 'CLE', 'Cleveland Browns', 'AFC North', '2023 Cleveland Browns', 79.0),
  ('nfl-division-cle-2007', 2007, 'CLE', 'Cleveland Browns', 'AFC North', '2007 Cleveland Browns', 78.5),
  ('nfl-division-cle-2002', 2002, 'CLE', 'Cleveland Browns', 'AFC North', '2002 Cleveland Browns', 78.0),
  ('nfl-division-pit-2005', 2005, 'PIT', 'Pittsburgh Steelers', 'AFC North', '2005 Pittsburgh Steelers', 96.0),
  ('nfl-division-pit-2008', 2008, 'PIT', 'Pittsburgh Steelers', 'AFC North', '2008 Pittsburgh Steelers', 95.5),
  ('nfl-division-pit-2010', 2010, 'PIT', 'Pittsburgh Steelers', 'AFC North', '2010 Pittsburgh Steelers', 91.0),
  ('nfl-division-pit-2004', 2004, 'PIT', 'Pittsburgh Steelers', 'AFC North', '2004 Pittsburgh Steelers', 89.5),
  ('nfl-division-hou-2025', 2025, 'HOU', 'Houston Texans', 'AFC South', '2025 Houston Texans', 83.5),
  ('nfl-division-hou-2012', 2012, 'HOU', 'Houston Texans', 'AFC South', '2012 Houston Texans', 83.5),
  ('nfl-division-hou-2011', 2011, 'HOU', 'Houston Texans', 'AFC South', '2011 Houston Texans', 82.0),
  ('nfl-division-hou-2018', 2018, 'HOU', 'Houston Texans', 'AFC South', '2018 Houston Texans', 81.5),
  ('nfl-division-ind-2006', 2006, 'IND', 'Indianapolis Colts', 'AFC South', '2006 Indianapolis Colts', 95.0),
  ('nfl-division-ind-2009', 2009, 'IND', 'Indianapolis Colts', 'AFC South', '2009 Indianapolis Colts', 92.5),
  ('nfl-division-ind-2005', 2005, 'IND', 'Indianapolis Colts', 'AFC South', '2005 Indianapolis Colts', 87.5),
  ('nfl-division-ind-2003', 2003, 'IND', 'Indianapolis Colts', 'AFC South', '2003 Indianapolis Colts', 87.5),
  ('nfl-division-jax-1999', 1999, 'JAX', 'Jacksonville Jaguars', 'AFC South', '1999 Jacksonville Jaguars', 91.0),
  ('nfl-division-jax-2017', 2017, 'JAX', 'Jacksonville Jaguars', 'AFC South', '2017 Jacksonville Jaguars', 85.5),
  ('nfl-division-jax-2025', 2025, 'JAX', 'Jacksonville Jaguars', 'AFC South', '2025 Jacksonville Jaguars', 84.0),
  ('nfl-division-jax-2007', 2007, 'JAX', 'Jacksonville Jaguars', 'AFC South', '2007 Jacksonville Jaguars', 82.5),
  ('nfl-division-ten-1999', 1999, 'TEN', 'Tennessee Titans', 'AFC South', '1999 Tennessee Titans', 91.0),
  ('nfl-division-ten-2008', 2008, 'TEN', 'Tennessee Titans', 'AFC South', '2008 Tennessee Titans', 85.5),
  ('nfl-division-ten-2000', 2000, 'TEN', 'Tennessee Titans', 'AFC South', '2000 Tennessee Titans', 85.5),
  ('nfl-division-ten-2003', 2003, 'TEN', 'Tennessee Titans', 'AFC South', '2003 Tennessee Titans', 84.0),
  ('nfl-division-den-2015', 2015, 'DEN', 'Denver Broncos', 'AFC West', '2015 Denver Broncos', 94.0),
  ('nfl-division-den-2013', 2013, 'DEN', 'Denver Broncos', 'AFC West', '2013 Denver Broncos', 93.0),
  ('nfl-division-den-2005', 2005, 'DEN', 'Denver Broncos', 'AFC West', '2005 Denver Broncos', 88.0),
  ('nfl-division-den-2025', 2025, 'DEN', 'Denver Broncos', 'AFC West', '2025 Denver Broncos', 87.0),
  ('nfl-division-kc-2022', 2022, 'KC', 'Kansas City Chiefs', 'AFC West', '2022 Kansas City Chiefs', 96.5),
  ('nfl-division-kc-2019', 2019, 'KC', 'Kansas City Chiefs', 'AFC West', '2019 Kansas City Chiefs', 96.5),
  ('nfl-division-kc-2023', 2023, 'KC', 'Kansas City Chiefs', 'AFC West', '2023 Kansas City Chiefs', 93.5),
  ('nfl-division-kc-2020', 2020, 'KC', 'Kansas City Chiefs', 'AFC West', '2020 Kansas City Chiefs', 92.0),
  ('nfl-division-lac-2006', 2006, 'LAC', 'San Diego Chargers', 'AFC West', '2006 San Diego Chargers', 87.5),
  ('nfl-division-lac-2007', 2007, 'LAC', 'San Diego Chargers', 'AFC West', '2007 San Diego Chargers', 86.0),
  ('nfl-division-lac-2009', 2009, 'LAC', 'San Diego Chargers', 'AFC West', '2009 San Diego Chargers', 85.0),
  ('nfl-division-lac-2004', 2004, 'LAC', 'San Diego Chargers', 'AFC West', '2004 San Diego Chargers', 84.0),
  ('nfl-division-lv-2002', 2002, 'LV', 'Oakland Raiders', 'AFC West', '2002 Oakland Raiders', 90.0),
  ('nfl-division-lv-2000', 2000, 'LV', 'Oakland Raiders', 'AFC West', '2000 Oakland Raiders', 88.0),
  ('nfl-division-lv-2016', 2016, 'LV', 'Oakland Raiders', 'AFC West', '2016 Oakland Raiders', 81.5),
  ('nfl-division-lv-2001', 2001, 'LV', 'Oakland Raiders', 'AFC West', '2001 Oakland Raiders', 81.0),
  ('nfl-division-dal-2007', 2007, 'DAL', 'Dallas Cowboys', 'NFC East', '2007 Dallas Cowboys', 85.0),
  ('nfl-division-dal-2016', 2016, 'DAL', 'Dallas Cowboys', 'NFC East', '2016 Dallas Cowboys', 84.5),
  ('nfl-division-dal-2023', 2023, 'DAL', 'Dallas Cowboys', 'NFC East', '2023 Dallas Cowboys', 84.0),
  ('nfl-division-dal-2014', 2014, 'DAL', 'Dallas Cowboys', 'NFC East', '2014 Dallas Cowboys', 84.0),
  ('nfl-division-nyg-2007', 2007, 'NYG', 'New York Giants', 'NFC East', '2007 New York Giants', 91.5),
  ('nfl-division-nyg-2011', 2011, 'NYG', 'New York Giants', 'NFC East', '2011 New York Giants', 90.0),
  ('nfl-division-nyg-2000', 2000, 'NYG', 'New York Giants', 'NFC East', '2000 New York Giants', 90.0),
  ('nfl-division-nyg-2008', 2008, 'NYG', 'New York Giants', 'NFC East', '2008 New York Giants', 84.0),
  ...
  ('nfl-division-phi-2022', 2022, 'PHI', 'Philadelphia Eagles', 'NFC East', '2022 Philadelphia Eagles', 93.0),
  ('nfl-division-phi-2004', 2004, 'PHI', 'Philadelphia Eagles', 'NFC East', '2004 Philadelphia Eagles', 92.0),
  ('nfl-division-was-2024', 2024, 'WAS', 'Washington Commanders', 'NFC East', '2024 Washington Commanders', 85.0),
  ('nfl-division-was-1999', 1999, 'WAS', 'Washington Redskins', 'NFC East', '1999 Washington Redskins', 81.0),
  ('nfl-division-was-2005', 2005, 'WAS', 'Washington Redskins', 'NFC East', '2005 Washington Redskins', 80.5),
  ('nfl-division-was-2012', 2012, 'WAS', 'Washington Redskins', 'NFC East', '2012 Washington Redskins', 79.5),
  ('nfl-division-chi-2006', 2006, 'CHI', 'Chicago Bears', 'NFC North', '2006 Chicago Bears', 93.0),
  ('nfl-division-chi-2001', 2001, 'CHI', 'Chicago Bears', 'NFC North', '2001 Chicago Bears', 85.0),
  ('nfl-division-chi-2018', 2018, 'CHI', 'Chicago Bears', 'NFC North', '2018 Chicago Bears', 84.0),
  ('nfl-division-chi-2010', 2010, 'CHI', 'Chicago Bears', 'NFC North', '2010 Chicago Bears', 83.5),
  ('nfl-division-det-2024', 2024, 'DET', 'Detroit Lions', 'NFC North', '2024 Detroit Lions', 88.0),
  ('nfl-division-det-2023', 2023, 'DET', 'Detroit Lions', 'NFC North', '2023 Detroit Lions', 85.0),
  ('nfl-division-det-2014', 2014, 'DET', 'Detroit Lions', 'NFC North', '2014 Detroit Lions', 80.5),
  ('nfl-division-det-2011', 2011, 'DET', 'Detroit Lions', 'NFC North', '2011 Detroit Lions', 80.5),
  ('nfl-division-gb-2010', 2010, 'GB', 'Green Bay Packers', 'NFC North', '2010 Green Bay Packers', 95.0),
  ('nfl-division-gb-2020', 2020, 'GB', 'Green Bay Packers', 'NFC North', '2020 Green Bay Packers', 88.5),
  ('nfl-division-gb-2011', 2011, 'GB', 'Green Bay Packers', 'NFC North', '2011 Green Bay Packers', 88.5),
  ('nfl-division-gb-2007', 2007, 'GB', 'Green Bay Packers', 'NFC North', '2007 Green Bay Packers', 88.5),
  ('nfl-division-min-2009', 2009, 'MIN', 'Minnesota Vikings', 'NFC North', '2009 Minnesota Vikings', 88.0),
  ('nfl-division-min-2017', 2017, 'MIN', 'Minnesota Vikings', 'NFC North', '2017 Minnesota Vikings', 87.0),
  ('nfl-division-min-2024', 2024, 'MIN', 'Minnesota Vikings', 'NFC North', '2024 Minnesota Vikings', 84.0),
  ('nfl-division-min-2000', 2000, 'MIN', 'Minnesota Vikings', 'NFC North', '2000 Minnesota Vikings', 82.5),
  ('nfl-division-atl-2016', 2016, 'ATL', 'Atlanta Falcons', 'NFC South', '2016 Atlanta Falcons', 90.0),
  ('nfl-division-atl-2012', 2012, 'ATL', 'Atlanta Falcons', 'NFC South', '2012 Atlanta Falcons', 87.5),
  ('nfl-division-atl-2010', 2010, 'ATL', 'Atlanta Falcons', 'NFC South', '2010 Atlanta Falcons', 84.5),
  ('nfl-division-atl-2004', 2004, 'ATL', 'Atlanta Falcons', 'NFC South', '2004 Atlanta Falcons', 83.0),
  ('nfl-division-car-2015', 2015, 'CAR', 'Carolina Panthers', 'NFC South', '2015 Carolina Panthers', 96.0),
  ('nfl-division-car-2003', 2003, 'CAR', 'Carolina Panthers', 'NFC South', '2003 Carolina Panthers', 88.0),
  ('nfl-division-car-2005', 2005, 'CAR', 'Carolina Panthers', 'NFC South', '2005 Carolina Panthers', 86.5),
  ('nfl-division-car-2013', 2013, 'CAR', 'Carolina Panthers', 'NFC South', '2013 Carolina Panthers', 83.5),
  ('nfl-division-no-2009', 2009, 'NO', 'New Orleans Saints', 'NFC South', '2009 New Orleans Saints', 98.5),
  ('nfl-division-no-2018', 2018, 'NO', 'New Orleans Saints', 'NFC South', '2018 New Orleans Saints', 88.5),
  ('nfl-division-no-2011', 2011, 'NO', 'New Orleans Saints', 'NFC South', '2011 New Orleans Saints', 88.0),
  ('nfl-division-no-2020', 2020, 'NO', 'New Orleans Saints', 'NFC South', '2020 New Orleans Saints', 85.0),
  ('nfl-division-tb-2002', 2002, 'TB', 'Tampa Bay Buccaneers', 'NFC South', '2002 Tampa Bay Buccaneers', 97.5),
  ('nfl-division-tb-2020', 2020, 'TB', 'Tampa Bay Buccaneers', 'NFC South', '2020 Tampa Bay Buccaneers', 96.0),
  ('nfl-division-tb-2021', 2021, 'TB', 'Tampa Bay Buccaneers', 'NFC South', '2021 Tampa Bay Buccaneers', 85.5),
  ('nfl-division-tb-1999', 1999, 'TB', 'Tampa Bay Buccaneers', 'NFC South', '1999 Tampa Bay Buccaneers', 83.0),
  ('nfl-division-ari-2015', 2015, 'ARI', 'Arizona Cardinals', 'NFC West', '2015 Arizona Cardinals', 88.0),
  ('nfl-division-ari-2008', 2008, 'ARI', 'Arizona Cardinals', 'NFC West', '2008 Arizona Cardinals', 85.0),
  ('nfl-division-ari-2021', 2021, 'ARI', 'Arizona Cardinals', 'NFC West', '2021 Arizona Cardinals', 80.5),
  ('nfl-division-ari-2009', 2009, 'ARI', 'Arizona Cardinals', 'NFC West', '2009 Arizona Cardinals', 79.5),
  ('nfl-division-lar-1999', 1999, 'LAR', 'St. Louis Rams', 'NFC West', '1999 St. Louis Rams', 99.5),
  ('nfl-division-lar-2001', 2001, 'LAR', 'St. Louis Rams', 'NFC West', '2001 St. Louis Rams', 96.0),
  ('nfl-division-lar-2021', 2021, 'LAR', 'Los Angeles Rams', 'NFC West', '2021 Los Angeles Rams', 94.5),
  ('nfl-division-lar-2018', 2018, 'LAR', 'Los Angeles Rams', 'NFC West', '2018 Los Angeles Rams', 92.0),
  ('nfl-division-sea-2025', 2025, 'SEA', 'Seattle Seahawks', 'NFC West', '2025 Seattle Seahawks', 99.0),
  ('nfl-division-sea-2013', 2013, 'SEA', 'Seattle Seahawks', 'NFC West', '2013 Seattle Seahawks', 99.0),
  ('nfl-division-sea-2005', 2005, 'SEA', 'Seattle Seahawks', 'NFC West', '2005 Seattle Seahawks', 93.0),
  ('nfl-division-sea-2014', 2014, 'SEA', 'Seattle Seahawks', 'NFC West', '2014 Seattle Seahawks', 91.0),
  ('nfl-division-sf-2019', 2019, 'SF', 'San Francisco 49ers', 'NFC West', '2019 San Francisco 49ers', 93.0),
  ('nfl-division-sf-2023', 2023, 'SF', 'San Francisco 49ers', 'NFC West', '2023 San Francisco 49ers', 91.0),
  ('nfl-division-sf-2012', 2012, 'SF', 'San Francisco 49ers', 'NFC West', '2012 San Francisco 49ers', 90.0),
  ('nfl-division-sf-2011', 2011, 'SF', 'San Francisco 49ers', 'NFC West', '2011 San Francisco 49ers', 88.5);
...
alter table private.auction_games
  ...
  add constraint auction_games_round_valid check (
    ...
    and current_round <= case
      ...
      when mode_id in ('longhorns-2005', 'longhorns-teams-2005', 'cowboys-2007', 'nfl-divisions') then 8
  ...
  add constraint auction_games_selection_counts_valid check (
    challenger_selection_count between 0 and case
      ...
      when mode_id in ('longhorns-2005', 'longhorns-teams-2005', 'cowboys-2007', 'nfl-divisions') then 4
  ...
  add constraint auction_games_bankroll_ceiling check (
    challenger_bankroll <= case
      ...
      when mode_id in ('longhorns-2005', 'longhorns-teams-2005', 'cowboys-2007', 'nfl-divisions') then 40
...
begin
  ...
  v_next := replace(
    ...
    'coalesce(catalog.display_label, trio.display_label, longhorn.display_name, longhorn_team.display_label, cowboy.display_name, nfl_division.display_label)'
  );
  v_next := replace(
    v_next,
    ...
    'catalog.item_reference is not null or trio.item_reference is not null or longhorn.item_reference is not null or longhorn_team.item_reference is not null or cowboy.item_reference is not null or nfl_division.item_reference is not null'
  );
