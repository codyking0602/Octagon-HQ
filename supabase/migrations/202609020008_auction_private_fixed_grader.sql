...
begin
  ...
  if v_game.content_version <> 'ufc-auction-2026-08-v1'
    or v_game.rarity_version <> 'balanced-rarity-2026-08-v1'
    or v_game.grading_version <> 'ufc-private-grader-2026-08-v1'
  then
...
drop function private.seed_auction_catalog_rows(text);
