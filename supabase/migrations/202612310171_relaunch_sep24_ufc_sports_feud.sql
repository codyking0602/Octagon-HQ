-- Service-only one-time reset for the held September 24 UFC Sports Feud.
-- The new Daily runtime invokes this immediately before materialization so the stale
-- pack cannot be recreated by the previously deployed held runtime during rollout.
