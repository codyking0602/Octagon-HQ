...
insert into private.auction_catalog (
  ...
  ('football-draft-room-2026-09-v2','build-qb','build-qb-bob-griese','Bob Griese',4,'Audited multi-source NFL QB profile from Football position-trait model v2',0.70,'qb',jsonb_build_object('Arm',78,'Accuracy',86,'Processing',93,'Mobility',60,'Clutch',93,'overall',82)),
  ...
  ('football-draft-room-2026-09-v2','build-qb','build-qb-trent-green','Trent Green',4,'Audited multi-source NFL QB profile from Football position-trait model v2',0.70,'qb',jsonb_build_object('Arm',86,'Accuracy',86,'Processing',93,'Mobility',60,'Clutch',78,'overall',81)),
  ...
  ('football-draft-room-2026-09-v2','build-qb','build-qb-jeff-garcia','Jeff Garcia',3,'Audited multi-source NFL QB profile from Football position-trait model v2',1.15,'qb',jsonb_build_object('Arm',78,'Accuracy',86,'Processing',86,'Mobility',93,'Clutch',78,'overall',84)),
  ...
  ('football-draft-room-2026-09-v2','build-qb','build-qb-alex-smith','Alex Smith',3,'Audited multi-source NFL QB profile from Football position-trait model v2',1.15,'qb',jsonb_build_object('Arm',78,'Accuracy',93,'Processing',93,'Mobility',78,'Clutch',78,'overall',84)),
  ...
  ('football-draft-room-2026-09-v2','build-qb','build-qb-andy-dalton','Andy Dalton',2,'Audited multi-source NFL QB profile from Football position-trait model v2',1.25,'qb',jsonb_build_object('Arm',78,'Accuracy',86,'Processing',86,'Mobility',60,'Clutch',69,'overall',76)),
  ...
  ('football-draft-room-2026-09-v2','build-qb','build-qb-jameis-winston','Jameis Winston',1,'Audited multi-source NFL QB profile from Football position-trait model v2',1.00,'qb',jsonb_build_object('Arm',99,'Accuracy',78,'Processing',60,'Mobility',69,'Clutch',69,'overall',75)),
