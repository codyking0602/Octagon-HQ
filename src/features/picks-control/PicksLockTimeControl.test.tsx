...
describe("Fight Night event-wide Picks deadline", () => {
  it("keeps the event-wide deadline as the master override and lets the owner extend it before the main card", async () => {
    ...
    expect(window.confirm).toHaveBeenCalledWith(expect.stringContaining("event-wide master deadline"));
  });
});