...
export const footballPersonIdentityKnowledgeSources: readonly FootballFactSource[] = [
  ...
  source("identity-butkus-bears-home", "Chicago Bears", "Butkus grateful to have played close to home", "https://www.chicagobears.com/news/bears-have-unearthed-star-players-from-hbcus", "Dick Butkus' Chicago roots and decision between the NFL Bears and AFL Broncos."),
