import { footballCfbChampionSeasonRows, footballQbCareerRows, footballRbCareerRows, type FootballCfbChampionSeasonRow, type FootballQbCareerRow, type FootballRbCareerRow } from "./footballFactualStatsCoverage";
...
function nflPasserRating(row: FootballQbCareerRow) {
...
function qbValue(row: FootballQbCareerRow, metricId: FootballFindLeaderMetricId): number | null {
  switch (metricId) {
...
function rbValue(row: FootballRbCareerRow, metricId: FootballFindLeaderMetricId): number | null {
