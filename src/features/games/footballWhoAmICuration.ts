...
const batch4RetainedIdentityConcepts = new Map<string, ReadonlySet<string>>([
  ["nfl-dave-robinson", keep("identity:dave-robinson-two-way-end-to-linebacker", "identity:dave-robinson-tight-end-jam-technique", "identity:dave-robinson-retirement-trade-return", "identity:pro-bowls")],
  ...
  ["nfl-cliff-harris", keep("identity:cliff-harris-undrafted-seventeen-rounds", "identity:cliff-harris-small-college-award", "identity:six-all-pro-all-nfc-selections")],
  ...
  ["nfl-darren-sharper", keep("identity:darren-sharper-underrecruited-quarterback")],
  ...
  ["nfl-eric-allen", keep("identity:eric-allen-nearly-retired-before-raiders", "identity:eric-allen-charles-woodson-oracle", "identity:upi-defensive-player-of-year-1993")],
  ["andy-reid", keep("identity:punt-pass-kick-giant-kid", "identity:holmgren-byu-connection")],
  ...
  ["bill-walsh", keep("identity:greg-cook-injury-offensive-pivot", "identity:late-head-coaching-breakthrough", "identity:49ers-three-year-turnaround", "identity:coaching-tree-legacy")],
  ["chuck-noll", keep("identity:messenger-guard-player-role", "identity:teacher-first-philosophy")],
  ["don-shula", keep("identity:pro-playing-career", "identity:youngest-head-coach-breakthrough")],
  ...
  ["nfl-jimmy-johnson-coach", keep()],
  ["joe-gibbs", keep("identity:don-coryell-protege")],
  ...
  ["tom-landry", keep("identity:multi-role-playing-career", "identity:player-coach-transition")],
  ["vince-lombardi", keep("identity:fordham-seven-blocks", "identity:pre-packers-coaching-path")],
  ["bill-cowher", keep("identity:linebacker-special-teamer-to-coach", "identity:super-bowl-onside-kick-gamble")],
  ["nfl-bud-grant", keep("identity:nfl-defensive-end-to-receiver-switch", "identity:contract-dispute-led-to-canada")],
  ...
  ["nfl-george-allen", keep("identity:george-allen-left-footed-practice-punter", "identity:george-allen-double-o-spy-patrol", "identity:nfl-coach-of-year-1967")],
]);
...
const batch4SupplementalClues = new Map<string, readonly WhoAmIClue[]>([
  ...
  ["bill-walsh", [
    ...
    batch4Clue("walsh-montana", "Joe Montana became the quarterback most closely associated with my offense in San Francisco.", "strong", "career-path"),
  ...
  ["joe-gibbs", [
    ...
    batch4Clue("gibbs-counter", "The counter-trey running concept became a signature part of my Washington offense.", "strong", "style"),
  ]],
  ["nfl-john-madden", [
  ...
  ["tom-landry", [
    ...
    batch4Clue("landry-giants-dc", "Before Dallas existed, I served as the Giants’ defensive coordinator while Vince Lombardi ran the offense.", "strong", "career-path"),
  ]],
  ["vince-lombardi", [
  ...
  ["bill-cowher", [
    ...
    batch4Clue("cowher-15", "I coached Pittsburgh for 15 seasons, from 1992 through 2006.", "strong", "career-path"),
  ...
  ["dick-vermeil", [
    ...
    batch4Clue("vermeil-rose", "Before the Eagles hired me, I coached UCLA to an upset victory over top-ranked Ohio State in the 1976 Rose Bowl.", "strong", "career-path"),
