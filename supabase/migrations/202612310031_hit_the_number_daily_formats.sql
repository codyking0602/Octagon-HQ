-- Extend the one canonical generalized Daily grader with server-owned Hit the Number
-- slot evidence. Historical Classic boards without format metadata remain valid.
