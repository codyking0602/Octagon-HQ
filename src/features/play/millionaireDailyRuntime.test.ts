...
describe("Millionaire official Daily runtime", () => {
  it("debuts CFB for Football and UFC for UFC on September 19", () => {
    ...
    expect(millionaireFootballDailyLeague("2026-09-27")).toBe("nfl");
  });

  it("rotates ten league-specific runs before repeating and advances hosts 1-2-3 by appearance", () => {
    const ufcDays = [
      "2026-09-19", "2026-09-28", "2026-10-07", "2026-10-15", "2026-10-21",
      "2026-10-28", "2026-11-06", "2026-11-14", "2026-11-20", "2026-11-27",
    ];
    const cfbDays = [
      "2026-09-19", "2026-10-05", "2026-10-17", "2026-10-31", "2026-11-12",
      "2026-11-26", "2026-12-08", "2026-12-22", "2027-01-03", "2027-01-17",
    ];
    const nflDays = [
      "2026-09-27", "2026-10-13", "2026-10-23", "2026-11-08", "2026-11-18",
      "2026-12-04", "2026-12-14", "2026-12-30", "2027-01-09", "2027-01-25",
    ];
