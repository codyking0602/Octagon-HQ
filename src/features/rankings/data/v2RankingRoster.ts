...
const rdaFightSeeds: readonly RdaFightSeed[] = [
  ...
  { date: "2010-08-07", opponent: "Clay Guida", result: "loss", method: "submission", tier: "solid", division: "Lightweight" },
  ...
  { date: "2012-07-11", opponent: "Anthony Njokuani", result: "win", method: "decision", tier: "solid", division: "Lightweight" },
  { date: "2012-11-17", opponent: "Mark Bocek", result: "win", method: "decision", tier: "top-ten", division: "Lightweight" },
  ...
  { date: "2018-06-09", opponent: "Colby Covington", result: "loss", method: "decision", tier: "top-five", division: "Welterweight", rounds: [1, 4], championshipType: "interim", championshipManualCredit: 0 },
  { date: "2018-11-30", opponent: "Kamaru Usman", result: "loss", method: "decision", tier: "champion-level", division: "Welterweight", rounds: [0, 5] },
