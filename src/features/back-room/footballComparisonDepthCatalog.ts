...
export const nflTeamEras = [
  ...
  nfl("nfl-era-browns-paul-brown", "Cleveland Browns — Paul Brown NFL dynasty", "6 straight NFL title games · 3 championships", 91, "A foundational NFL dynasty with repeated title-game dominance; era distance keeps it below the modern benchmark dynasties.", "cle", "Cleveland Browns"),
  ...
  nfl("nfl-era-dolphins-shula", "Miami Dolphins — Shula early dynasty", "3 straight Super Bowls · 2 championships", 89, "Back-to-back championships and the perfect 1972 season anchor a short historic peak.", "mia", "Miami Dolphins"),
  ...
  nfl("nfl-era-rams-greatest-show-on-turf", "St. Louis Rams — Greatest Show on Turf", "2 Super Bowl appearances · 1 championship", 84, "An era-defining offensive peak with a championship and repeat Super Bowl trip.", "lar", "Rams"),
  nfl("nfl-era-broncos-elway-shanahan", "Denver Broncos — Elway/Shanahan title era", "Back-to-back championships", 82, "A compact repeat-title peak earns Great placement without the longevity of the longer dynasty windows.", "den", "Denver Broncos"),
  nfl("nfl-era-cowboys-landry", "Dallas Cowboys — Landry first dynasty", "5 Super Bowl appearances · 2 championships", 81, "Long contention and two championships make this a strong all-time era, but the extended window softens the peak.", "dal", "Dallas Cowboys"),
  nfl("nfl-era-49ers-steve-young", "San Francisco 49ers — Steve Young contender era", "Super Bowl XXIX champion · sustained contention", 81, "A championship and years of elite play form a strong second 49ers window without matching the Montana/Walsh dynasty.", "sf", "San Francisco 49ers"),
  nfl("nfl-era-ravens-ray-lewis", "Baltimore Ravens — Ray Lewis era", "2 championships · defining defense", 81, "Two titles and one of the era's defining defenses balance a long window with uneven offense.", "bal", "Baltimore Ravens"),
  nfl("nfl-era-bills-four-super-bowls", "Buffalo Bills — four straight Super Bowls", "4 straight Super Bowl appearances", 80, "Four consecutive conference championships are historically rare, while the lack of a title keeps the era in Good.", "buf", "Buffalo Bills"),
  nfl("nfl-era-saints-brees-payton", "New Orleans Saints — Brees/Payton era", "Super Bowl XLIV champion · long offensive peak", 80, "A championship and sustained elite offense make this a strong era, but not an inner-circle dynasty.", "no", "New Orleans Saints"),
  nfl("nfl-era-broncos-peyton-manning", "Denver Broncos — Peyton Manning era", "2 Super Bowl appearances · 1 championship", 79, "A short high-end window with record offense and a championship finish lands comfortably in Good.", "den", "Denver Broncos"),
  nfl("nfl-era-rams-mcvay", "Los Angeles Rams — McVay first contender era", "2 Super Bowl appearances · 1 championship", 78, "Two title-game trips and a championship in five seasons create a clear Good-era résumé.", "lar", "Los Angeles Rams"),
  nfl("nfl-era-packers-favre-holmgren", "Green Bay Packers — Favre/Holmgren era", "2 straight Super Bowls · 1 championship", 69, "A championship peak and repeat Super Bowl trip are strong, but the short reviewed window sits near the middle of this all-time era pool.", "gb", "Green Bay Packers"),
  nfl("nfl-era-buccaneers-brady", "Tampa Bay Buccaneers — Brady era", "Super Bowl LV champion · 3-year window", 69, "A championship gives the short window real weight, while its limited duration keeps it around the middle of the all-time era pool.", "tb", "Tampa Bay Buccaneers"),
  nfl("nfl-era-vikings-purple-people-eaters", "Minnesota Vikings — Purple People Eaters era", "4 Super Bowl appearances", 68, "Repeated conference dominance without a championship makes this a recognizable middle-tier all-time era.", "min", "Minnesota Vikings"),
  nfl("nfl-era-eagles-hurts-sirianni", "Philadelphia Eagles — Hurts/Sirianni contender era", "2 Super Bowl appearances · 1 championship", 68, "A fast championship-level rise is balanced by a still-short era window, keeping it in Average for this historical pool.", "phi", "Philadelphia Eagles"),
  nfl("nfl-era-bills-allen-mcdermott", "Buffalo Bills — Allen/McDermott contender era", "6 straight playoff seasons · repeated AFC contention", 54, "Excellent regular seasons without a Super Bowl appearance leave this contender window below the average accomplishment level of the famous eras in this pack.", "buf", "Buffalo Bills"),
] as const satisfies readonly FootballComparisonDepthItem[];
...
export const collegeRunningBacks = [
  ...
  cfb("ezekiel-elliott-cfb", "Ezekiel Elliott", "Ohio State · national champion · 3,961 rushing yards", 88, "Championship-driving postseason peak and two elite full seasons make Elliott clearly Great rather than a middle-tier career.", 194, "Ohio State"),
  ...
  cfb("dalvin-cook-cfb", "Dalvin Cook", "Florida State · school rushing record", 86, "Three explosive seasons and Florida State's career rushing record make Cook an obvious Great-tier college back.", 52, "Florida State"),
  ...
  cfb("leonard-fournette-cfb", "Leonard Fournette", "LSU · 3,830 rushing yards", 79, "A dominant sophomore peak and strong three-year SEC production put Fournette comfortably above Average without overstating the career.", 99, "LSU"),
...
export const collegeHeadCoaches = [
  ...
  cfb("bobby-bowden-cfb", "Bobby Bowden", "2 national titles · Florida State dynasty", 96, "Two national titles and decades of elite Florida State contention make Bowden an obvious elite all-time coach rather than an Average result from a partial data window.", 52, "Florida State"),
  ...
  cfb("steve-spurrier-cfb", "Steve Spurrier", "1996 national title · 6 SEC titles", 93, "A national title, repeated SEC dominance and major offensive influence make Spurrier an obvious elite historical coach.", 57, "Florida"),
  ...
  cfb("lou-holtz-cfb", "Lou Holtz", "1988 national title · Notre Dame", 88, "A national championship, long major-program résumé and successful rebuilds place Holtz firmly in Great.", 87, "Notre Dame"),
  ...
  cfb("les-miles-cfb", "Les Miles", "2007 national title · 2 SEC titles", 84, "A national title and sustained LSU contention make Miles clearly stronger than the compressed Average cluster.", 99, "LSU"),
  ...
  cfb("frank-beamer-cfb", "Frank Beamer", "238 wins at Virginia Tech · title-game appearance", 83, "Decades of program building and sustained national relevance put Beamer comfortably in Great.", 259, "Virginia Tech"),
  ...
  cfb("bill-snyder-cfb", "Bill Snyder", "2 Big 12 titles · Kansas State rebuild", 82, "One of college football's defining program-building careers belongs above the generic Average cluster.", 2306, "Kansas State"),
  ...
  cfb("butch-jones-cfb", "Butch Jones", "Tennessee · recognizable SEC underachievement", 48, "Some winning seasons never became SEC contention, and the Tennessee tenure finished with a clear collapse.", 2633, "Tennessee"),
  cfb("scott-frost-cfb", "Scott Frost", "UCF breakthrough · 16–31 at Nebraska", 45, "The UCF peak is recognizable, but four-plus losing Nebraska seasons make the full major-program résumé clearly below average.", 158, "Nebraska"),
  cfb("willie-taggart-cfb", "Willie Taggart", "Florida State · short unsuccessful tenure", 43, "Program-building flashes elsewhere were overwhelmed by a brief, losing Florida State tenure at the highest-profile stop.", 52, "Florida State"),
  cfb("jeremy-pruitt-cfb", "Jeremy Pruitt", "Tennessee · no winning SEC season", 38, "Three Tennessee seasons never produced sustained winning or SEC contention.", 2633, "Tennessee"),
  cfb("charlie-weis-cfb", "Charlie Weis", "Notre Dame / Kansas · major-program disappointments", 34, "Early Notre Dame momentum gave way to repeated losing seasons, followed by a severe Kansas failure.", 87, "Notre Dame"),
  cfb("derek-dooley-cfb", "Derek Dooley", "Tennessee · three losing SEC seasons", 32, "A recognizable SEC tenure without a winning conference season belongs near the bottom of this historical coaching pool.", 2633, "Tennessee"),
