...
describe("post-lock official result corrections", () => {
  ...
  it("keeps the owner UI explicit about confirmation-only automatic recalculation", () => {
    ...
    expect(controlPage).toContain("Owner confirmed official result correction");
    expect(controlPage).not.toContain("Explain why this official result is changing");
