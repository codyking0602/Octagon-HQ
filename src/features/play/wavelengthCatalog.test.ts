...
describe("canonical Wavelength catalog", () => {
  ...
  it("documents explicit calibration and historical version identifiers", () => {
    ...
    expect(WAVELENGTH_GENERATOR_VERSION).toBe("wavelength-generator-v4");
    ...
    expect(WAVELENGTH_HISTORICAL_VERSION_IDS).toContain("wavelength-generator-v3");
...
describe("Wavelength official privacy projection", () => {
  ...
  it("preserves Wavelength privacy while joining the seven-game official daily lineup", () => {
