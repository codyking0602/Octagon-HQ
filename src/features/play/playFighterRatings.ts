...
const rankedStrikingEvidence: Record<string, number> = {
...
const rankedGrapplingEvidence: Record<string, number> = {
...
function reviewedRankedCategoryRating(evidence: Record<string, number>, name: string) {
  const target = normalizedName(name);
  return Object.entries(evidence).find(([candidate]) => normalizedName(candidate) === target)?.[1];
}

/**
 * Ranked identities and career OVR stay projected from the canonical calculated
 * ranking model. Established Play category evidence is owned once here; any
 * ranked fighter without reviewed category evidence derives from that model.
 */
export function projectRankedPlayRatings(fighter: RankingFighter): PlayCategoryRatings {
  ...
  return {
    career: fighter.ovr,
    striking: reviewedRankedCategoryRating(rankedStrikingEvidence, fighter.name)
      ?? clamp((prime * 0.45) + (finish * 0.3) + (apex * 0.25)),
    grappling: reviewedRankedCategoryRating(rankedGrapplingEvidence, fighter.name)
      ?? clamp((quality * 0.32) + (championship * 0.28) + (control * 0.4)),
  };
}
...
export const playOnlyFighterRatings: readonly PlayOnlyFighterRatingEvidence[] = [
  ...
  e("efrain-escudero", "Efrain Escudero", "men", ["Lightweight"], "TUF Boom", "TUF winner with multiple UFC lightweight stints and an uneven UFC record", { career: 48, striking: 52, grappling: 64 }),
...
e("thibault-gouti", "Thibault Gouti", "men", ["Lightweight"], "ESPN+ Era", "One-win UFC lightweight run with five UFC losses", { career: 26, striking: 54, grappling: 35 }),
  ...
  e("tatiana-suarez", "Tatiana Suarez", "women", ["Strawweight", "Flyweight"], "ESPN+ Era", "UFC strawweight title challenger with wins over former UFC champions", { career: 80, striking: 65, grappling: 93 }),
e("manon-fiorot", "Manon Fiorot", "women", ["Flyweight"], "ESPN+ Era", "UFC flyweight title challenger with a sustained ranked contender run", { career: 81, striking: 88, grappling: 60 }),
e("erin-blanchfield", "Erin Blanchfield", "women", ["Flyweight"], "ESPN+ Era", "UFC flyweight contender with wins over former UFC champions", { career: 78, striking: 70, grappling: 89 }),
e("yan-xiaonan", "Yan Xiaonan", "women", ["Strawweight"], "ESPN+ Era", "UFC strawweight title challenger and long-ranked contender", { career: 79, striking: 86, grappling: 58 }),
e("virna-jandiroba", "Virna Jandiroba", "women", ["Strawweight"], "ESPN+ Era", "UFC strawweight title challenger with a deep ranked contender run", { career: 78, striking: 58, grappling: 91 }),
e("irene-aldana", "Irene Aldana", "women", ["Bantamweight"], "ESPN+ Era", "UFC bantamweight title challenger with ranked knockout wins", { career: 72, striking: 84, grappling: 49 }),
e("hannah-cifers", "Hannah Cifers", "women", ["Strawweight"], "ESPN+ Era", "UFC strawweight run with two wins and a prolonged losing stretch", { career: 31, striking: 58, grappling: 28 }),
e("pearl-gonzalez", "Pearl Gonzalez", "women", ["Strawweight"], "Fox / PPV Boom", "Two-fight UFC strawweight run without a UFC win", { career: 18, striking: 42, grappling: 49 }),
e("bec-rawlings", "Bec Rawlings", "women", ["Strawweight", "Flyweight"], "Fox / PPV Boom", "UFC strawweight and flyweight run with two wins and five losses", { career: 32, striking: 57, grappling: 42 }),
e("rachael-ostovich", "Rachael Ostovich", "women", ["Flyweight"], "ESPN+ Era", "UFC flyweight run with one win in four UFC appearances", { career: 25, striking: 43, grappling: 48 }),
e("jessamyn-duke", "Jessamyn Duke", "women", ["Bantamweight"], "Fox / PPV Boom", "UFC bantamweight run with one win and a four-fight losing stretch", { career: 27, striking: 53, grappling: 39 }),
e("alexis-dufresne", "Alexis Dufresne", "women", ["Bantamweight"], "Fox / PPV Boom", "Two-fight UFC bantamweight run without a UFC win", { career: 16, striking: 34, grappling: 50 }),
  ...
  e("mark-hunt", "Mark Hunt", "men", ["Heavyweight"], "Fox / PPV Boom", "UFC interim heavyweight title challenger with a long knockout-heavy UFC run", { career: 64, striking: 82, grappling: 44 }),
  e("tai-tuivasa", "Tai Tuivasa", "men", ["Heavyweight"], "ESPN+ Era", "UFC heavyweight contender and knockout-focused veteran", { career: 60, striking: 79, grappling: 34 }),
  e("ben-rothwell", "Ben Rothwell", "men", ["Heavyweight"], "Fox / PPV Boom", "Long UFC heavyweight contender run with ranked wins", { career: 62, striking: 68, grappling: 69 }),
  e("travis-browne", "Travis Browne", "men", ["Heavyweight"], "Fox / PPV Boom", "UFC heavyweight contender with wins over top UFC heavyweights", { career: 63, striking: 76, grappling: 52 }),
  e("gabriel-gonzaga", "Gabriel Gonzaga", "men", ["Heavyweight"], "Fox / PPV Boom", "UFC heavyweight title challenger and submission-and-knockout veteran", { career: 61, striking: 66, grappling: 78 }),
  e("marcin-tybura", "Marcin Tybura", "men", ["Heavyweight"], "ESPN+ Era", "Long UFC heavyweight contender run with durable winning stretches", { career: 67, striking: 62, grappling: 74 }),
  e("matt-mitrione", "Matt Mitrione", "men", ["Heavyweight"], "Fox / PPV Boom", "UFC heavyweight veteran with multiple knockout wins", { career: 57, striking: 72, grappling: 43 }),
  e("jairzinho-rozenstruik", "Jairzinho Rozenstruik", "men", ["Heavyweight"], "ESPN+ Era", "UFC heavyweight contender and knockout specialist", { career: 64, striking: 81, grappling: 36 }),
  e("brendan-schaub", "Brendan Schaub", "men", ["Heavyweight"], "Fox / PPV Boom", "UFC heavyweight veteran with mixed UFC results", { career: 52, striking: 56, grappling: 61 }),
  e("walt-harris", "Walt Harris", "men", ["Heavyweight"], "ESPN+ Era", "UFC heavyweight veteran with limited sustained UFC success", { career: 42, striking: 58, grappling: 35 }),
  e("antonio-silva", "Antonio Silva", "men", ["Heavyweight"], "Fox / PPV Boom", "UFC heavyweight title challenger known as Bigfoot with an uneven UFC tenure", { career: 54, striking: 62, grappling: 61 }),
  e("chase-sherman", "Chase Sherman", "men", ["Heavyweight"], "ESPN+ Era", "Long UFC heavyweight tenure with low-end UFC results", { career: 30, striking: 45, grappling: 30 }),
  ...
  e("antonio-rodrigo-nogueira", "Antonio Rodrigo Nogueira", "men", ["Heavyweight"], "TUF Boom", "UFC interim heavyweight champion with notable UFC heavyweight wins", { career: 71, striking: 62, grappling: 91 }),
