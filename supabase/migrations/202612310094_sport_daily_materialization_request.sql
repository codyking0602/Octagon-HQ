-- Resolve sport-scoped Daily materialization before any setup regeneration.
-- Published Daily rows remain immutable; callers must reuse an existing day instead of
-- attempting to republish it from newer runtime code.
