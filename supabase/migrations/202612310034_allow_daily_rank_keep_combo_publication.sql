-- Extend the one canonical Daily publication RPC to admit the bundled Rank/Keep scoring identity.
-- Historical Wavelength, Blind Resume, Blind Rank, and standalone Keep/Cut identities remain valid.
