...
function DraftRoomBoard({
  ...
  const openRosterMode = trioMode || longhornsFamilyMode || nflDivisionsMode || cowboysMode;
  ...
  return (
    <div className={`auction-board${longhornsFamilyMode ? " auction-board--longhorns" : ""}${nflDivisionsMode ? " auction-board--nfl-divisions" : ""}${cowboysMode ? " auction-board--cowboys" : ""}`}>
      ...
      {!rosterResult ? <section className="auction-current surface-card">
        ...
        >
          <small>{trioMode ? "CURRENT TRIO" : nflDivisionsMode ? "CURRENT TEAM-SEASON" : longhornsTeamsMode ? "CURRENT TEXAS TEAM" : longhornsMode ? "CURRENT LONGHORN" : cowboysMode ? "CURRENT COWBOY" : "CURRENT QB"}</small>
          {trioMode ? (
      ...
      {latestRound && !rosterResult ? (
        <section className="auction-result surface-card" aria-label="Latest Draft Room result">
          ...
          <h2>{latestAward ? (trioMode ? "Trio awarded" : latestAward.display_label) : (trioMode ? "Resolved trio" : nflDivisionsMode ? "Resolved NFL team-season" : longhornsTeamsMode ? "Resolved Texas team" : longhornsMode ? "Resolved Longhorn" : cowboysMode ? "Resolved Cowboy" : "Resolved QB")}</h2>
          <p>
      ...
      {state.lifecycle_state === "completed"
        ...
        <section className="auction-final surface-card" aria-label={trioMode ? "Trio final result" : nflDivisionsMode ? "NFL Divisions final result" : longhornsTeamsMode ? "Longhorns Teams final result" : longhornsMode ? "Longhorns final result" : cowboysMode ? "Cowboys final result" : "Build a QB final result"}>
          ...
          {!openRosterMode ? (
            ...
            <p className="draft-room-trio-bid-note">
              {trioMode
                ...
                : nflDivisionsMode
                  ? "Bid on this NFL team-season. The server chooses the division board; win four seasons to build the stronger group."
                : longhornsTeamsMode
