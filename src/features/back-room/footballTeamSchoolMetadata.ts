...
export const footballTeamSchoolMetadata: readonly FootballTeamSchoolMetadata[] = [
  ...
  cfb("USC", "West Coast", ["cardinal", "gold"], history({ from: 1922, to: 1958, conference: "PCC" }, { from: 1959, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, to: 2023, conference: "Pac-12" }, { from: 2024, conference: "Big Ten" }), ["Southern California"]),
  cfb("UCLA", "West Coast", ["blue", "gold"], history({ from: 1928, to: 1958, conference: "PCC" }, { from: 1959, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, to: 2023, conference: "Pac-12" }, { from: 2024, conference: "Big Ten" })),
  cfb("Oregon", "Pacific Northwest", ["green", "yellow", "white"], history({ from: 1916, to: 1958, conference: "PCC" }, { from: 1959, to: 1963, conference: "Independent" }, { from: 1964, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, to: 2023, conference: "Pac-12" }, { from: 2024, conference: "Big Ten" })),
  cfb("Washington", "Pacific Northwest", ["purple", "gold"], history({ from: 1916, to: 1958, conference: "PCC" }, { from: 1959, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, to: 2023, conference: "Pac-12" }, { from: 2024, conference: "Big Ten" })),
  cfb("Stanford", "West Coast", ["cardinal", "white"], history({ from: 1918, to: 1958, conference: "PCC" }, { from: 1959, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, to: 2023, conference: "Pac-12" }, { from: 2024, conference: "ACC" })),
  cfb("California", "West Coast", ["blue", "gold"], history({ from: 1916, to: 1958, conference: "PCC" }, { from: 1959, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, to: 2023, conference: "Pac-12" }, { from: 2024, conference: "ACC" }), ["Cal"]),
  cfb("Oregon State", "Pacific Northwest", ["orange", "black", "white"], history({ from: 1916, to: 1958, conference: "PCC" }, { from: 1959, to: 1963, conference: "Independent" }, { from: 1964, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, conference: "Pac-12" })),
  cfb("Washington State", "Pacific Northwest", ["crimson", "gray", "white"], history({ from: 1917, to: 1958, conference: "PCC" }, { from: 1959, to: 1961, conference: "Independent" }, { from: 1962, to: 1967, conference: "AAWU" }, { from: 1968, to: 1977, conference: "Pac-8" }, { from: 1978, to: 2010, conference: "Pac-10" }, { from: 2011, conference: "Pac-12" })),
