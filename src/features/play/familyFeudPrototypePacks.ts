...
const footballEntities: readonly FamilyFeudEntity[] = [
  ...
  entity("adrian-peterson", "Adrian Peterson", ["Adrian", "AP", "All Day"]),
...
export const FOOTBALL_FAMILY_FEUD_PROTOTYPE: FamilyFeudPack = {
  ...
  mainBoards: [
    question(
      ...
      cowboysCandidates,
      ["ceedee", "micah", "dak", "trevon"],
      MAIN_POINTS,
      ["pollard", "amari", "zeke", "turpin", "bland", "ferguson"],
    ),
    question(
      "football-clutch-qbs-2010s",
      "Which QBs from the 2010s would you want down 4 late?",
      clutchQbCandidates,
      ["brady", "rodgers", "mahomes", "brees"],
      MAIN_POINTS,
      ["peyton", "russ", "big-ben", "luck", "eli", "cam", "matt-ryan"],
    ),
  ],
  fastMoney: [
    question(
...
export const UFC_FAMILY_FEUD_PROTOTYPE: FamilyFeudPack = {
  ...
  mainBoards: [
    question(
      ...
      ["ngannou", "derrick-lewis", "jds", "mark-hunt"],
      MAIN_POINTS,
      ["stipe", "overeem", "carwin", "cain", "roy-nelson", "werdum"],
    ),
    question(
      ...
      ["gaethje", "poirier", "ferguson", "mcgregor"],
      MAIN_POINTS,
      ["barboza", "pettis", "cerrone", "nate", "eddie", "khabib"],
    ),
  ],
  fastMoney: [
    question(
