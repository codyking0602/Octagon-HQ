...
export const CFB_SPORTS_FEUD_FAST_3 = expandSportsFeudFamilies("cfb-fast3", [
  ...
  },
  {
    ...
    collisionGroup: "traditions",
    prompts: [
      "Name a famous school-specific college football tradition.",
      "Name an iconic tradition tied to one college football program.",
      "Name a college football ritual strongly associated with a specific school.",
      "Name a school-specific Saturday tradition fans recognize.",
      "Name a college football tradition you can immediately connect to one school.",
    ],
    answers: [
      { name: "Ohio State dotting the i", aliases: ["Dotting the i", "Dot the i", "Script Ohio"] },
      { name: "Clemson running down the hill", aliases: ["Running down the hill", "Run down the hill", "Clemson hill"] },
      { name: "Virginia Tech Enter Sandman", aliases: ["Enter Sandman", "Sandman"] },
      { name: "Wisconsin Jump Around", aliases: ["Jump Around"] },
      { name: "Texas A&M 12th Man", aliases: ["12th Man", "Twelfth Man"] },
      { name: "Florida State spear plant", aliases: ["Spear plant", "Plant the spear", "FSU spear"] },
      { name: "Notre Dame Play Like a Champion Today", aliases: ["Play Like a Champion", "Play Like a Champion Today"] },
      { name: "Oklahoma Sooner Schooner", aliases: ["Sooner Schooner", "Schooner"] },
    ],
  },
  {
    category: "rivalries",
