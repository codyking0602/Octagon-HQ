...
const oct27Rows: readonly EntityRow[] = [
  ...
  ["jimmy-rollins", "Jimmy Rollins", ["J-Roll", "J Roll", "Rollins"]],
  ["johnny-damon", "Johnny Damon", ["Damon"]],
  ["alfonso-soriano", "Alfonso Soriano", ["Soriano"]],
  ["trea-turner", "Trea Turner", ["Trea"]],
  ["ronald-acuna-jr", "Ronald Acuna Jr.", ["Ronald Acuña Jr.", "Ronald Acuna", "Ronald Acuña", "Acuna", "Acuña"]],
  ["curtis-granderson", "Curtis Granderson", ["Granderson"]],
  ["jacoby-ellsbury", "Jacoby Ellsbury", ["Ellsbury"]],
  ["kyle-schwarber", "Kyle Schwarber", ["Schwarber"]],
  ["rafael-furcal", "Rafael Furcal", ["Furcal"]],
  ["dexter-fowler", "Dexter Fowler", ["Fowler"]],
...
export const MLB_SPORTS_FEUD_OCT27_PACK: FamilyFeudPack = {
  ...
  fastMoney: [
    ...
    question(
      OCT27_PREFIX,
      "fast-leadoff-hitter",
      "Name an MLB player since 2000 you strongly associate with hitting leadoff.",
      [
        "mookie-betts", "jose-altuve", "jimmy-rollins", "johnny-damon",
        "alfonso-soriano", "trea-turner", "ronald-acuna-jr", "curtis-granderson",
        "jacoby-ellsbury", "kyle-schwarber",
      ],
      FAST_POINTS,
      ["rafael-furcal", "dexter-fowler"],
    ),
    question(
      OCT27_PREFIX,
      "fast-utility-player",
