...
export const footballPersonIdentityKnowledgeSources: readonly FootballFactSource[] = [
  ...
  source("identity-reggie-packers-hof", "Green Bay Packers", "Packers Hall Of Fame To Induct Reggie White", "https://www.packers.com/news/reggie-white-packers-hall-of-fame-to-induct-reggie-white-2452048", "Reggie White's Minister of Defense identity, major free-agent signing, and Packers jersey retirement."),
