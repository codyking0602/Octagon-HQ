-- Keep repeated monitoring-failure notifications tied to automatic provider work.
-- Manual owner checks and scheduler decisions remain visible in Monitoring Inbox,
-- but they cannot create the owner escalation.
