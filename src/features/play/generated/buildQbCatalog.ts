...
export const generatedBuildQbCatalog: readonly GeneratedBuildQbCatalogRow[] = [
  ...
  { catalogId: "build-qb-philip-rivers", displayName: "Philip Rivers", rarityBand: 4, generationWeight: 0.70, overall: 77, traits: { Arm: 86, Accuracy: 93, Processing: 93, Mobility: 35, Clutch: 78 } },
  ...
  { catalogId: "build-qb-lamar-jackson", displayName: "Lamar Jackson", rarityBand: 4, generationWeight: 0.70, overall: 91, traits: { Arm: 86, Accuracy: 86, Processing: 93, Mobility: 99, Clutch: 93 } },
  ...
  { catalogId: "build-qb-russell-wilson", displayName: "Russell Wilson", rarityBand: 3, generationWeight: 1.15, overall: 90, traits: { Arm: 93, Accuracy: 93, Processing: 78, Mobility: 93, Clutch: 93 } },
  ...
  { catalogId: "build-qb-michael-vick", displayName: "Michael Vick", rarityBand: 3, generationWeight: 1.15, overall: 81, traits: { Arm: 99, Accuracy: 69, Processing: 69, Mobility: 99, Clutch: 69 } },
  { catalogId: "build-qb-randall-cunningham", displayName: "Randall Cunningham", rarityBand: 3, generationWeight: 1.15, overall: 85, traits: { Arm: 93, Accuracy: 78, Processing: 78, Mobility: 99, Clutch: 78 } },
  { catalogId: "build-qb-donovan-mcnabb", displayName: "Donovan McNabb", rarityBand: 3, generationWeight: 1.15, overall: 86, traits: { Arm: 86, Accuracy: 78, Processing: 86, Mobility: 93, Clutch: 86 } },
  ...
  { catalogId: "build-qb-tony-romo", displayName: "Tony Romo", rarityBand: 3, generationWeight: 1.15, overall: 84, traits: { Arm: 78, Accuracy: 93, Processing: 93, Mobility: 78, Clutch: 78 } },
  ...
  { catalogId: "build-qb-ken-anderson", displayName: "Ken Anderson", rarityBand: 3, generationWeight: 1.15, overall: 85, traits: { Arm: 78, Accuracy: 99, Processing: 93, Mobility: 69, Clutch: 86 } },
  { catalogId: "build-qb-ken-stabler", displayName: "Ken Stabler", rarityBand: 3, generationWeight: 1.15, overall: 84, traits: { Arm: 78, Accuracy: 86, Processing: 86, Mobility: 69, Clutch: 99 } },
  { catalogId: "build-qb-joe-namath", displayName: "Joe Namath", rarityBand: 3, generationWeight: 1.15, overall: 83, traits: { Arm: 99, Accuracy: 78, Processing: 78, Mobility: 60, Clutch: 99 } },
  ...
  { catalogId: "build-qb-len-dawson", displayName: "Len Dawson", rarityBand: 3, generationWeight: 1.15, overall: 83, traits: { Arm: 78, Accuracy: 93, Processing: 93, Mobility: 60, Clutch: 93 } },
  ...
  { catalogId: "build-qb-joe-flacco", displayName: "Joe Flacco", rarityBand: 2, generationWeight: 1.25, overall: 81, traits: { Arm: 99, Accuracy: 78, Processing: 78, Mobility: 50, Clutch: 99 } },
  { catalogId: "build-qb-drew-bledsoe", displayName: "Drew Bledsoe", rarityBand: 2, generationWeight: 1.25, overall: 74, traits: { Arm: 99, Accuracy: 78, Processing: 78, Mobility: 35, Clutch: 78 } },
  ...
  { catalogId: "build-qb-vinny-testaverde", displayName: "Vinny Testaverde", rarityBand: 2, generationWeight: 1.25, overall: 74, traits: { Arm: 93, Accuracy: 69, Processing: 69, Mobility: 60, Clutch: 78 } },
  { catalogId: "build-qb-mark-brunell", displayName: "Mark Brunell", rarityBand: 2, generationWeight: 1.25, overall: 83, traits: { Arm: 78, Accuracy: 86, Processing: 86, Mobility: 86, Clutch: 78 } },
  { catalogId: "build-qb-jim-everett", displayName: "Jim Everett", rarityBand: 2, generationWeight: 1.25, overall: 76, traits: { Arm: 86, Accuracy: 86, Processing: 78, Mobility: 60, Clutch: 69 } },
  ...
  { catalogId: "build-qb-jeff-george", displayName: "Jeff George", rarityBand: 1, generationWeight: 1.00, overall: 66, traits: { Arm: 99, Accuracy: 69, Processing: 50, Mobility: 60, Clutch: 50 } },
  { catalogId: "build-qb-justin-herbert", displayName: "Justin Herbert", rarityBand: 1, generationWeight: 1.00, overall: 87, traits: { Arm: 99, Accuracy: 93, Processing: 86, Mobility: 86, Clutch: 69 } },
  ...
  { catalogId: "build-qb-kyler-murray", displayName: "Kyler Murray", rarityBand: 1, generationWeight: 1.00, overall: 85, traits: { Arm: 93, Accuracy: 86, Processing: 78, Mobility: 99, Clutch: 69 } },
