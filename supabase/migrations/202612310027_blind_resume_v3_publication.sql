-- Extend the one canonical Daily publication RPC to admit Blind Resume V3 scoring.
-- Historical Blind Resume V2 and calibrated Wavelength identities remain accepted unchanged.
...
begin
  ...
  if not (
    ...
    or (p_game_type not in ('wavelength', 'blind_resume') and p_scoring_version = 'play-official-score-v1')
  ) then
