...
export function whyNotProfileCopy(fighter: { rank: number; slug: string; whyNotHigher?: string }) {
  ...
  if (fighter.whyNotHigher) return fighter.whyNotHigher;
  ...
  return "They cannot rank higher on this board. The debate is whether the gap over the fighters below is large enough, not whether a stronger UFC resume currently sits above them.";
}
