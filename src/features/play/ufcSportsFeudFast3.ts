...
export const UFC_SPORTS_FEUD_FAST_3 = expandSportsFeudFamilies("ufc-fast3", [
  ...
  },
  {
    ...
    prompts: [
      "Name a fighter in the UFC Hall of Fame.",
      "Name a UFC legend whose career earned Hall of Fame recognition.",
      "Name a fighter you associate with the UFC Hall of Fame.",
      "Name an all-time UFC name honored by the promotion.",
      "Name a fighter whose legacy belongs in a UFC Hall of Fame conversation.",
    ],
