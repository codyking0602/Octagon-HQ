-- Keep major ranking feed items and their shared previews on neutral UFC rankings copy.

update private.whats_new_items
set title = 'The UFC rankings had a major shakeup',
    summary = 'Several fighters moved three or more spots across the UFC boards.'
where kind = 'major_ranking_update';
