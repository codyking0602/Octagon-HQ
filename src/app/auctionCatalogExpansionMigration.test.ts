...
const reviewedFighterPerformances = [
  ...
  {
    "label": "José Aldo performance vs Urijah Faber — UFC 169",
    "score": 96
  },
  {
  ...
  {
    "label": "Cody Garbrandt performance vs Dominick Cruz — UFC 207",
    "score": 97
  },
  {
    "label": "T.J. Dillashaw performance vs Renan Barão — UFC 173",
    "score": 98
  },
  {
  ...
  {
    "label": "Lyoto Machida performance vs Rashad Evans — UFC 98",
    "score": 97
  },
  {
...
describe("Auction catalog expansion migration", () => {
  ...
  it("contains current career identities and mode-specific category membership", () => {
    ...
    const reviewedTitleBouts = new Set([
      "Georges St-Pierre vs Matt Hughes — UFC 65", "Frankie Edgar vs Gray Maynard — UFC 125", "Jon Jones vs Alexander Gustafsson — UFC 165", "Jose Aldo vs Chad Mendes — UFC 179",
      ...
      "Anderson Silva vs Chael Sonnen — UFC 117", "Demetrious Johnson vs Ray Borg — UFC 216", "Amanda Nunes vs Cris Cyborg — UFC 232", "Dominick Cruz vs T.J. Dillashaw — UFC Fight Night 81",
      ...
      "Valentina Shevchenko vs Taila Santos — UFC 275", "Charles Oliveira vs Michael Chandler — UFC 262", "Matt Hughes vs Frank Trigg — UFC 52", "Conor McGregor vs Eddie Alvarez — UFC 205",
