...
export const CFB_BUILD_QB_PEAK_SEASON_AUDIT: readonly CfbBuildQbPeakAuditRow[] = [
  ...
  peak("Deshaun Watson", 2016, "Clemson", "cfbfast-r-player-3122840-deshaun-watson", 5, [8, 8, 8, 8, 9]),
  peak("Lamar Jackson", 2016, "Louisville", "cfbfast-r-player-3916387-lamar-jackson", 5, [7, 7, 6, 9, 7]),
  peak("Baker Mayfield", 2017, "Oklahoma", "cfbfast-r-player-550373-baker-mayfield", 5, [8, 9, 9, 7, 8]),
  ...
  peak("Kyler Murray", 2018, "Oklahoma", "cfbfast-r-player-3917315-kyler-murray", 5, [9, 8, 8, 9, 7]),
  peak("Tua Tagovailoa", 2018, "Alabama", "cfbfast-r-player-4241479-tua-tagovailoa", 4, [7, 9, 8, 7, 8]),
  peak("Trevor Lawrence", 2019, "Clemson", "cfbfast-r-player-4360310-trevor-lawrence", 4, [9, 8, 8, 8, 8]),
  peak("Joe Burrow", 2019, "LSU", "cfbfast-r-player-3915511-joe-burrow", 5, [8, 9, 9, 7, 9]),
  peak("Jalen Hurts", 2019, "Oklahoma", "cfbfast-r-player-4040715-jalen-hurts", 4, [7, 7, 7, 9, 8]),
  peak("Justin Fields", 2019, "Ohio State", "cfbfast-r-player-4362887-justin-fields", 4, [8, 8, 8, 9, 8]),
  ...
  peak("Bryce Young", 2021, "Alabama", "cfbfast-r-player-4685720-bryce-young", 5, [7, 9, 9, 8, 9]),
  ...
  peak("Caleb Williams", 2022, "USC", "cfbfast-r-player-4431611-caleb-williams", 5, [9, 8, 7, 9, 8]),
  ...
  peak("Michael Penix Jr.", 2023, "Washington", "cfbfast-r-player-4360423-michael-penix-jr", 4, [9, 8, 8, 4, 9]),
  peak("Bo Nix", 2023, "Oregon", "cfbfast-r-player-4426338-bo-nix", 4, [7, 9, 9, 7, 7]),
  peak("Jayden Daniels", 2023, "LSU", "cfbfast-r-player-4426348-jayden-daniels", 5, [8, 9, 8, 9, 8]),
  ...
  peak("Quinn Ewers", 2023, "Texas", "cfbfast-r-player-4889929-quinn-ewers", 2, [7, 7, 6, 4, 7]),
  peak("Dillon Gabriel", 2024, "Oregon", "cfbfast-r-player-4427238-dillon-gabriel", 3, [6, 7, 9, 6, 7]),
  peak("Shedeur Sanders", 2024, "Colorado", "cfbfast-r-player-4432762-shedeur-sanders", 3, [7, 9, 7, 5, 6]),
