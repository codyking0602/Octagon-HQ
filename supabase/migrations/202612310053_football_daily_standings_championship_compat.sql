-- Preserve the championship-era reset introduced by 202612310022 while keeping the
-- sport-aware standings owner introduced for Football. The Football projection keeps its
-- launch-week history; only UFC applies the historical 2026-08-10 championship cutoff.
