...
import type { PickBout, PickEventMemberProgress } from "./picksModel";

interface GroupPickProgressProps {
  members: readonly PickEventMemberProgress[];
  bouts: readonly PickBout[];
  locked: boolean;
...
export function GroupPickProgress({ members, bouts, locked, mySelections }: GroupPickProgressProps) {
  ...
  }, [bouts, locked, mySelections, selected]);
