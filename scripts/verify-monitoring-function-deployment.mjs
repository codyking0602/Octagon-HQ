...
for (const version of ["202608080001", "202608090001", "202608090002", "202608090003", "202609120001", "202612310002", "202612310047", "202612310048"]) {
...
console.log(`PASS: run-pick-monitoring exact source, live-state/result migrations, scheduler infrastructure, server authorization, quota secret, CORS, and no-provider-call rejection paths verified for ${expectedSha}.`);
