...
const VISUAL_META_BY_PACK: Record<FootballRankFivePackId, FootballSubjectVisualMeta> = {
  ...
  "nfl-front-seven": { kind: "player", shortLabel: "F7", folder: "players" },
  "nfl-secondary": { kind: "player", shortLabel: "DB", folder: "players" },
  ...
  "nfl-team-eras": { kind: "program", shortLabel: "ERA", folder: "teams" },
  ...
  "college-running-backs": { kind: "player", shortLabel: "RB", folder: "players" },
