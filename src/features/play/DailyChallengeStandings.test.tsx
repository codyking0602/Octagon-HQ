...
function member(overrides: Partial<TodayChallengeStandingsEntry>): TodayChallengeStandingsEntry {
  return {
    ...
    gameAverages: { findLeader: 84, wavelength: null, blindResume: 90, blindRank5: 82, keep4Cut4: 87, hitTheNumber: 91, whoAmI: 86, millionaire: 88 },
...
describe("Daily Challenge championship standings", () => {
  ...
  it("shows Daily Double, Hit the Number, Who Am I, and Millionaire averages", () => {
    const standings: TodayChallengeStandings = {
