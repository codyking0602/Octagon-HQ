...
export const shanesWatchlist = {
  ...
  fighters: [
    ...
    },
    {
      ...
      ufcWinStreak: "0",
      ufcFinishes: "0",
      whyOnBoard: "A 45-second DWCS TKO earned him a UFC contract, with his debut already booked for August 29.",
      boardNote: "Explosive, creative flyweight with real finishing pop. The UFC debut should tell us a lot fast.",
      scoutingSnapshot: "Hasan arrives in the UFC as an unbeaten 9–0 flyweight with a taekwondo base and real one-shot speed. His Contender Series audition lasted just 45 seconds, when he stopped Mridul Saikia with punches to earn a contract. He gets an immediate chance to validate the hype in his UFC debut against fellow unbeaten prospect Nilson Rojas on August 29.",
      photoUrl: null,
