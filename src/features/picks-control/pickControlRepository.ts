...
const controlBoutSchema = z.object({
  ...
  live_status: z.enum(["scheduled", "live", "final"]),
  live_status_provider: z.literal("espn").nullable().optional().default(null),
...
export function mapPickControlEvent(value: unknown): PickControlEvent | null {
  ...
  return {
    ...
    bouts: parsed.bouts.map((bout) => ({
      ...
      liveStatus: bout.live_status,
      liveStatusProvider: bout.live_status_provider,
