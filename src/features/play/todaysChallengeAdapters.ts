...
export const TODAY_CHALLENGE_ADAPTERS = {
  ...
  millionaire: {
    ...
    instructions: "Eight questions. Three lifelines. Climb from $500 to $1,000,000.",
    footballInstructions: "Eight questions. Three lifelines. Climb from $500 to $1,000,000.",
