...
export const FOOTBALL_CFB_BUILD_QB_CATALOG_VERSION = "football-draft-room-2026-09-v6";
export const FOOTBALL_CFB_BUILD_QB_RARITY_VERSION = "football-draft-room-rarity-2026-09-v4";
export const FOOTBALL_CFB_BUILD_QB_GRADING_VERSION = "football-build-qb-traits-2026-09-v2";
